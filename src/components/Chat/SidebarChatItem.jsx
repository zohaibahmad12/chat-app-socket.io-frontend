  ...
  return (
    <li className="flex items-center w-full p-3 bg-gray-900 hover:bg-gray-700 transition duration-300 shadow-md rounded-md">
      <div className="relative">
        ...
        <FaCircle className={`absolute bottom-0 right-0 w-3 h-3 rounded-full ${online ? "text-green-400" : "text-gray-500"}`} />
      </div>
      ...
      <div className="flex-1 ml-3">
        ...
        <p className="text-sm text-gray-400 flex items-center">
          ...
          {status === "viewed" && <FaCheckDouble className="ml-1 text-blue-400" />}
        </p>
      </div>
    </li>
  );
